...
const Footer = () => {
    return (
        <footer className="bg-[#FFFFFF] text-gray-300 py-2 px-2 md:px-8">
            <div className="container mx-auto block items-center md:px-[96px] md:py-[80px]">

                <div className="block dark-[#1F2937] pt-[40px] md:p-[100px] items-center ">
                    <button className='rounded-xl  text-[#4B5563] mb-6 ml-[140px] md:ml-[500px]  font-medium text-base font-[Inter] bg-[#E5E7EB] py-2 px-5'>Get in touch</button>
                    <p className=" dark:text-white font-normal  max-w-[570px]  text-center  font-[Inter]  mb-2  text-xl text-gray-600">
                ...
                <div className="block  ml-[0px] md:ml-[360px] p-4 mt-4 md:mt-[100px]  items-center ">
